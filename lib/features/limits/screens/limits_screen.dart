...
class LimitsScreen extends StatefulWidget {
  ...
  @override State<LimitsScreen> createState() => _LimitsScreenState();
}
...
class _LimitsScreenState extends State<LimitsScreen>
  ...
  Widget build(BuildContext context) {
    return Column(children: [
      _buildTabs(),
      Padding(padding: const EdgeInsets.fromLTRB(12,8,12,0), child: _buildInputPanel()),
        ...
        for (int i = 0; i < 2; i++) Expanded(child: GestureDetector(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              color: _tab.index == i ? _color.withOpacity(0.2) : Colors.transparent,
              borderRadius: BorderRadius.circular(7),
              border: _tab.index == i ? Border.all(color: _color.withOpacity(0.5)) : null,
            ),
            child: Center(child: Text(
              i == 0 ? 'lim x→a f(x)' : "ロピタルの定理",
              style: TextStyle(fontFamily: 'IBM Plex Mono', fontSize: 12,
  ...
  Widget _buildInputPanel() {
    if (_mode == LimitsTab.limit) {
      return Column(children: [
        ...
        // 方向
        Row(children: [
          const Text('極限の方向:', style: TextStyle(
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text(label, style: TextStyle(fontSize: 10, fontFamily: 'Space Grotesk',
            fontWeight: FontWeight.w600, color: active ? _color : AppTheme.textMuted)),
  ...
  Widget _dirBtn(String label, String val) {
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        child: Text(label, style: TextStyle(fontFamily: 'Space Grotesk', fontSize: 11,
  ...
  Widget _buildExamples() {
    return Padding(
      ...
      child: Wrap(spacing: 6, children: _examples.map((e) => GestureDetector(
        onTap: () {
          setState(() {
            _f['expr'] = e.$1;
            _f['point'] = e.$2.replaceAll('x→', '')
                .replaceAll('∞', 'Infinity');
            _activeField = 'expr';
          });
        },
        child: Container(
          ...
          child: Text('${e.$1}  ${e.$2}', style: TextStyle(
            fontFamily: 'IBM Plex Mono', fontSize: 11, color: _color)),
        ),
      )).toList()),
    );
  }
  ...
  Widget _buildKeyboard() {
    return Padding(
      ...
      child: Column(children: [
        _kr([
          _k('AC', () { setState(() { _f.updateAll((k,_)=>''); _result=''; }); }, r: true),
          _k('⌫', _bs, o: true),
          _k('(', () => _ap('(')),
          _k(')', () => _ap(')')),
        ]),
        ...
        _kr([
          _k('7',()=>_ap('7')), _k('8',()=>_ap('8')),
          _k('9',()=>_ap('9')), _k('/',()=>_ap('/'), o:true),
        ]),
        _kr([
          _k('4',()=>_ap('4')), _k('5',()=>_ap('5')),
          _k('6',()=>_ap('6')), _k('*',()=>_ap('*'), o:true),
        ]),
        _kr([
          _k('1',()=>_ap('1')), _k('2',()=>_ap('2')),
          _k('3',()=>_ap('3')), _k('-',()=>_ap('-'), o:true),
        ]),
        _kr([
          _k('0',()=>_ap('0')), _k('.',()=>_ap('.')),
          _k('+',()=>_ap('+'), o:true),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [BoxShadow(
            color: Colors.black.withOpacity(0.2), offset: const Offset(0,2), blurRadius: 4)],
        ),
