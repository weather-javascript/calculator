...
class _CalculatorHomeState extends State<CalculatorHome> {
    ...
    return Container(
      ...
      child: Row(mainAxisSize: MainAxisSize.min, children: [
        ...
        Text(_engineReady ? 'CAS Ready' : '初期化中',
            style:
                TextStyle(fontFamily: 'IBM Plex Mono', fontSize: 9, color: c)),
      ]),
    );
  }
                          ...
                          Row(
                            ...
                            return GestureDetector(
                              ...
                              child: AnimatedContainer(
                                ...
                                decoration: BoxDecoration(
                                  color: active
                                      ? inf.color.withOpacity(0.18)
                                      : const Color(0xFF1A2235),
                                  borderRadius: BorderRadius.circular(20),
                                  border: Border.all(
                                      color: active
                                          ? inf.color.withOpacity(0.6)
  ...
  Widget _screen() {
    switch (_mode) {
      ...
      case CalcMode.calculus:
        return const CalculusScreen();
      case CalcMode.combinatorics:
        return const CombinatoricsScreen();
      case CalcMode.sequences:
        return const SequencesScreen();
      case CalcMode.statistics:
        return const StatisticsScreen();
      case CalcMode.algebra:
        return const AlgebraScreen();
      case CalcMode.trigonometry:
        return const TrigonometryScreen();
      case CalcMode.complex:
        return const ComplexScreen();
      case CalcMode.limits:
        return const LimitsScreen();
      case CalcMode.linearAlgebra:
        return const LinearAlgebraScreen();
      case CalcMode.numberTheory:
        return const NumberTheoryScreen();
      case CalcMode.graph:
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
          ...
          AnimatedSwitcher(
            ...
            child: Text(
                ...
                style: TextStyle(
                    fontFamily: 'IBM Plex Mono',
                    fontSize: s.displayResult.length > 14
                        ? 24
                        : s.displayResult.length > 10
                            ? 32
                            : 42,
